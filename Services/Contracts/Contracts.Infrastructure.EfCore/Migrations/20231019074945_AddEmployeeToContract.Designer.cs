...
namespace Contracts.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20231019074945_AddEmployeeToContract")]
    partial class AddEmployeeToContract
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Contracts.Domain.ContractAggregate.Contract", b =>
                {
                    ...
                    b.HasOne("Contracts.Domain.EmployeeAggregate.Employee", "CustomerServiceRep")
                        .WithMany()
                        .HasForeignKey("CustomerServiceRepId");

                    b.HasOne("Contracts.Domain.EmployeeAggregate.Employee", "SalePerson")
                        .WithMany()
                        .HasForeignKey("SalePersonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Contracts.Domain.EmployeeAggregate.Employee", "Supervisor")
                        .WithMany()
