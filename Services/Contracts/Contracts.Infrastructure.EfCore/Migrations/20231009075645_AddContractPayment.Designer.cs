...
namespace Contracts.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20231009075645_AddContractPayment")]
    partial class AddContractPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contracts.Domain.ContractAggregate.ContractPayment", b =>
                {
                    b.HasOne("Contracts.Domain.ContractAggregate.Contract", "Contract")
                        .WithMany()
                        .HasForeignKey("ContractId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Contracts.Domain.PaymentMethodAggregate.PaymentMethod", "PaymentMethod")
                        .WithMany()
